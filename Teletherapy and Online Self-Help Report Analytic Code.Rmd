...
Updated with removal of 4 test responses
...
for(outcome in outcomes) {
  ...
  out[[paste0(outcome, ".pct")]][out$label == "All"] <- percent(mean(df[[outcome]]))
  ...
  for(i in 2:nrow(out)) {
    ...
    out[[paste0(outcome, ".pct")]][i] <- paste0(percent(mean(df[[outcome]][df[[variable]] == level])))
